...
cask "ksail" do
  ...
  on_macos do
    on_arm do
      sha256 "8a3a781e3ea6002dc46cd62634428573af39cc0d366777259343696baf92ea04"
      url "https://github.com/devantler-tech/ksail/releases/download/v#{version}/ksail_#{version}_darwin_arm64.tar.gz"
    end
  end
  on_linux do
    on_arm do
      sha256 "e9e6ef49553267843ef74aaf4a0e719e76e3a3dbce0f81bcc9d31231973f9f5d"
      url "https://github.com/devantler-tech/ksail/releases/download/v#{version}/ksail_#{version}_linux_arm64.tar.gz"
    end
    on_intel do
      sha256 "4378bac769533b261cca9e58bb8004b86d9f23a4d7ef43dc0585bfca640ed6a9"
